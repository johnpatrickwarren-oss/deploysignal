...
- **sigma_floor_applied audit field: 66 cells** — all `tool_success_rate`, exactly matching the cross-signal grep prediction at `coordination/DIAGNOSTIC-V1-H1-GREP-2026-04-26.md`.
