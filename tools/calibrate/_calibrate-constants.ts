...
import type { TenantTier, TenantTierConfig } from '../../engine/types';
...
export const LEGACY_CUTOFFS: Record<string, number> = {
  p99:           1.20,
  ttft:          1.20,
  compound:      1.12,
  behavioral:    1.18,
...
export const CUTOFF_SIGNAL: Record<string, string | null> = {
  p99:           'p99_latency',
  ttft:          'ttft',
...
export const HEALTHY_MEANS: Record<string, number> = {
...
// Week-2+ work.
export const LEGACY_VOTE_THRESHOLDS: Record<string, number> = {
...
export const MIN_SAMPLES_STRICT = 60;
export const MIN_SAMPLES_POOLED = 20;
...
export const TRAFFIC_GATE_MIN = 0.10;
...
export const MSPRT_MIN_SAMPLES_LEGACY = 0;
 ...
 *  request falls into. */
export const EMITTED_TIERS: TenantTier[] = ['dominant', 'large', 'medium', 'small', 'aggregate'];

// ── Q2.B.6.1 Step 2: integration-state-audit ─────────────────────────
export const AUDIT_TOL = 1e-8;
export const Q2_B_6_1_PSD_EPS_RELATIVE = 1e-9;
