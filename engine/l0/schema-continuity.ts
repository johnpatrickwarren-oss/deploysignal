// Returned to DeploySignal from the engine on 2026-09-23 (engine ADR 0033 step 3; was
// adapters/l0/schema-continuity.ts in @johnpatrickwarren-oss/deploysignal-engine v0.7.0-pre, and before that
// vendored FROM this repo at main@5a72371 on 2026-05-16). DeploySignal owns this file; the engine
// copy is deleted at its next major.
 ...
 *  table. */
// anchor:allow no-complex-functions: returned unchanged from the engine's adapters/ at v0.7.0-pre (ADR 0033 step 3); grandfathered there, not new code
