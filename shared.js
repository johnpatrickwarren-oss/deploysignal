...
var ROLLBACK_DEFS = [
  ...
  { id:'p99', label:'p99 Latency',
    ...
    check: function(m,b,f,ctx,tb) {
      ...
      if (t.cv !== undefined && t.cv > 0.20 && (t.n < 6 || t.slopeNorm <= 0.012) && _hbmRp99 <= 1.10) return false; var _hbmRp99 = (b.hbm_spill > 0 && m.hbm_spill !== undefined) ? m.hbm_spill/b.hbm_spill : 1; var _kvDp99 = (b.kv_cache > 0) ? Math.abs(m.kv_cache - b.kv_cache)/b.kv_cache : 0; if (t.cv !== undefined && t.cv > 0.25 && (b.p99_latency <= 0 || m.p99_latency/b.p99_latency < 1.03) && tr > 1.10) return false; if (t.cv !== undefined && t.cv > 0.30 && _hbmRp99 > 1.12 && _kvDp99 < 0.03) return true; if (t.cv !== undefined && t.cv > 0.30 && _hbmRp99 > 1.10 && _hbmRp99 <= 1.12 && _kvDp99 < 0.03) return false;
